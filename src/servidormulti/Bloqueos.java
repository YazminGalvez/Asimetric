...
public class Bloqueos {
    ...
    public static boolean bloquearUsuario(String bloqueador, String bloqueado) {
        if (bloqueador.equalsIgnoreCase(bloqueado)) return false;
        try (Connection conn = BaseDatos.getConnection()) {
            Integer idBloqueador = BdUsuario.obtenerIdUsuario(bloqueador);
            Integer idBloqueado = BdUsuario.obtenerIdUsuario(bloqueado);
            if (idBloqueador == null || idBloqueado == null) return false;
            return ejecutarBloqueo(conn, idBloqueador, idBloqueado);
    ...
    private static boolean ejecutarBloqueo(Connection conn, Integer idBloqueador, Integer idBloqueado) throws SQLException {
    ...
    public static boolean desbloquearUsuario(String bloqueador, String bloqueado) {
        try (Connection conn = BaseDatos.getConnection()) {
            ...
            return ejecutarDesbloqueo(conn, idBloqueador, idBloqueado);
        } catch (SQLException e) {
    ...
    private static boolean ejecutarDesbloqueo(Connection conn, Integer idBloqueador, Integer idBloqueado) throws SQLException {
    ...
    public static boolean estaBloqueadoPor(String emisor, String receptor) {
        try (Connection conn = BaseDatos.getConnection()) {
            Integer idEmisor = BdUsuario.obtenerIdUsuario(emisor);
            Integer idReceptor = BdUsuario.obtenerIdUsuario(receptor);

            if (idEmisor == null || idReceptor == null) return false;

            return chequearBloqueo(conn, idEmisor, idReceptor);
        } catch (SQLException e) {
    ...
    private static boolean chequearBloqueo(Connection conn, Integer idEmisor, Integer idReceptor) throws SQLException {
